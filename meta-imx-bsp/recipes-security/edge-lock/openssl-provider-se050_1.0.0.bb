...
SRC_URI = "${OPENSSL_SE050_SRC};branch=${OPENSSL_SE050_SRCBRANCH}"
OPENSSL_SE050_SRC ?= "gitsm://github.com/NXPPlugNTrust/se05x-openssl-provider.git;protocol=https"
OPENSSL_SE050_SRCBRANCH ?= "main"
