...
SRC_URI[md5sum] = "ea0e413a8b8e2f471a39ec54b75ea18d"
SRC_URI[sha256sum] = "217c6491b89448568ed8f6738b48998df7ce480305bb001d86283d0e2de25f66"
...
do_deploy () {
    ...
    if [ "${IS_MX8}" = "8mq" ]; then
        ...
        # Deploy hdmi/cadence
        install -m 0644 ${S}/firmware/hdmi/cadence/hdmitx.bin ${DEPLOYDIR}
