...
IMX_EXTRA_FIRMWARE      = "firmware-imx imx-sc-firmware imx-seco"
IMX_EXTRA_FIRMWARE_mx8m = "firmware-imx"
DEPENDS += " \
    u-boot \
    ${IMX_EXTRA_FIRMWARE} \
    imx-atf \
...
deploy_mx8m() {
    ...
    install -m 0644 ${DEPLOY_DIR_IMAGE}/signed_*_imx8m.bin   ${DEPLOYDIR}/${BOOT_TOOLS}
...
deploy_mx8() {
    ...
    install -m 0644 ${BOOT_STAGING}/m41_tcm.bin              ${DEPLOYDIR}/${BOOT_TOOLS}
