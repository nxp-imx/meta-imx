...
SRC_URI = "${SOURCEFORGE_MIRROR}/ltp/ltp-full-${PV}.tar.bz2"
SRC_URI += " file://Exclude_ffsb-6.0-rc2.patch"

S = "${WORKDIR}/ltp-full-${PV}"

SRC_URI[md5sum] = "686b7fc02e130f6a882475b9d75bd04b"
SRC_URI[sha256sum] = "8ad64bb41a9bb9b5c04b07e2e09e562371b343dd767af245ec12e0034e498cfb"
