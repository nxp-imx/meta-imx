...
PACKAGECONFIG[wayland] = "-DENABLE_WAYLAND=ON -DENABLE_UNSUPPORTED_EXPERIMENTAL_POSSIBLY_BROKEN_WAYLAND=ON,-DENABLE_WAYLAND=OFF,wayland-native wayland wayland-protocols"
